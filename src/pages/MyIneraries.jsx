  ...
  return (
    ...
    <div className="ContainerHeaderItineraries">
        <div className="TitulosDeCities">
          <h3 className="subtituloCities">Here you will be able to create your itineraries to your liking</h3>
          <h1 className="tituloCities">
            <span className="colorNaranjaDeLinea">| </span>HERE YOU CAN SEE THE ITINERARIES CREATED
          </h1>
        </div>
      </div>
    ...
    <h3 className="subtituloCities"><span className="colorNaranjaDeLinea">| </span>My Itinearies</h3>
