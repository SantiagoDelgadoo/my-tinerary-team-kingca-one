...
export default function NavBar() {
  ...
  let { token, photo, logged, name, role } = useSelector((store) => store.userReducer);
      ...
      <div className="ContainerHome1">
        ...
        {seeLogin ? (
          <div className="usuario">
            ...
            {!logged ? <img src="./img/usuario.png" onClick={change} alt="Usuario" /> :<img src= {photo} onClick={change} alt="Usuario" />
            }
              
              {!logged ? <><NavLink style={{ textDecoration: "none" }} to="/signin">
            ...
            <ul>You are already logged in as {name}</ul>
