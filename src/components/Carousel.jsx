  ...
  return (
    <>
      <div className="flex-column">
        <h2>
          <span className="colorNaranjaDeLinea">| </span>CITIES
        </h2>
        <div className="conteinerCarousel">
          ...
          <div className="carousel">
            <img
              ...
              alt={cities[numberOfChange + 0].photo}
              className="photoCarrusel"
            />
            <img
              src={cities[numberOfChange + 1].photo}
              alt={cities[numberOfChange + 1].photo}
              className="photoCarrusel"
            />
            <img
              src={cities[numberOfChange + 2].photo}
              alt={cities[numberOfChange + 2].photo}
              className="photoCarrusel"
            />
          </div>
        ...
        <h2>
          <span className="colorNaranjaDeLinea">| </span>PLACES
        </h2>
        <div className="conteinerCarousel">
          <Arrow icon={"<"} onClick={prev} />
          <div className="carousel">
            <img
              src={places[numberOfChange + 2].photo[0]}
              alt={places[numberOfChange + 2].name}
              className="photoCarrusel"
            />
            <img
              src={places[numberOfChange + 2].photo[1]}
              alt={places[numberOfChange + 2].name}
              className="photoCarrusel"
            />
            <img
              src={places[numberOfChange + 2].photo[2]}
              alt={places[numberOfChange + 2].name}
              className="photoCarrusel"
            />
          </div>
